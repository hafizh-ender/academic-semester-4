...
We're using the data from \citet{Palar_et_al_2023} about flutter detection on NACA 64A10 airfoil. The data is retrieved from a numerical experiment which investigates the safety regime of a NACA 64A010 with two degrees of freedom: pitch and plunge motion. The study investigates the impact of two design conditions, namely, the Mach number and the flutter speed. A numerical aerodynamic solver was employed with the Mach number and the flutter speed as inputs, and the damping coefficient as the output. The illustration of the airfoil is shown in Figure \ref{fig:case3_airfoil}.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{graph/case3_problem.jpg}
    \caption{\label{fig:case3_airfoil}NACA 64A010 Airfoil}
\end{figure}
